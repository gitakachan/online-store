        ...
        >
          ...
          <div class="border-bottom border-white border-2">
            ...
            <div>
              ...
              <ListTemplate :listItem="nav.nature.sightSeeing.listItem">
          ...
          <div class="border-bottom border-white border-2">
            ...
            <div>
              ...
              <ListTemplate :listItem="nav.food.food.stores.listItem">
                <template v-slot:header>
                  <h4>{{ nav.food.food.stores.title }}</h4>
                </template>
              </ListTemplate>

              <ListTemplate :listItem="nav.food.drinks.listItem">
                <template v-slot:header>
                  <h3>{{ nav.food.drinks.title }}</h3>
                </template>
              </ListTemplate>

              <ListTemplate :listItem="nav.food.drinks.stores.listItem">
                <template v-slot:header>
          ...
          <div class="pb-3">
            ...
            <ListTemplate :listItem="nav.specialty.specialty.listItem">
              <template v-slot:header>
